...
function VerifyOtpForm() {
  ...
  const handleVerify = useCallback(async (otpString: string) => {
  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden" aria-hidden="true">
        <div className="animate-float absolute top-16 left-24 w-56 h-56 rounded-full opacity-20"
          style={{ background: "#F5C518", filter: "blur(48px)" }} />
        <div className="animate-float-delayed absolute bottom-24 right-16 w-48 h-48 rounded-full opacity-15"
            ...
            <AnimatePresence mode="wait">
              {success ? (
                ...
                >
                  ...
                  <h1 className="text-2xl font-extrabold" style={{ fontFamily: "var(--font-nunito)", color: "#1A1A1A" }}>
                    Email Verified! 🎉
                  </h1>
            ...
            <>
                ...
                {otp.map((digit, i) => (
                  <motion.input
                    ...
                    style={{
                      ...
                      color: "#1A1A1A",
                      boxShadow: digit ? "0 0 0 3px rgba(245, 197, 24, 0.2)" : "none",
                    }}
              ...
              <div className="text-center">
                ...
                {canResend ? (
                  ...
                  <p className="text-sm font-semibold" style={{ color: "#9CA3AF", fontFamily: "var(--font-nunito)" }}>
