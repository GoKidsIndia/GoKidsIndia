...
export default async function AttentionSpanAssessmentPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-8">
      ...
      <div className="border-b border-gray-200/80 pb-6 space-y-2">
        <div className="flex items-center gap-3">
          <span className="text-3xl">🧠</span>
          <h1 
            className="text-2xl sm:text-3xl font-extrabold text-brand-black tracking-tight"
            style={{ fontFamily: "var(--font-heading)" }}
          >
        ...
        <p className="text-sm sm:text-base text-gray-500 font-semibold leading-relaxed">
          A science-backed cognitive screening task designed to measure sustained focus, impulse control, and sensory attention in children aged 8–16.
        </p>
      </div>
      ...
      {children.length === 0 ? (
        <div className="pt-6">
          <div className="max-w-md mx-auto bg-white rounded-[32px] p-8 border border-gray-150 shadow-md space-y-6 text-center">
            ...
            <p className="text-sm text-gray-500 font-semibold leading-relaxed">
              To start an assessment, you must first add a child profile to your dashboard. This helps us personalize the assessment questions and track their results accurately.
            </p>
            <Link
